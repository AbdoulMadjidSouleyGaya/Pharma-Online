...
<head>
  ...
  <title>Admin — Ajouter une pharmacie</title>
  <style>
...
<body>
  ...
  <div class="wrap">
    <div class="panel">
      <h2 style="margin:0 0 8px">Ajouter une pharmacie</h2>
      <p class="muted">Renseignez au minimum <b>Nom</b> et <b>Quartier</b>.</p>
      ...
      <form method="POST" action="{{ route('admin.pharmacies.store') }}">
        ...
        <label>Adresse</label>
        <input type="text" name="address" value="{{ old('address') }}" placeholder="Adresse précise (optionnel)">
